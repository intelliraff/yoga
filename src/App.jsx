        ...
        <div className={`mobile-nav ${isMobileMenuOpen ? 'mobile-nav-open' : ''}`}>
          ...
          <div className="mobile-nav-content">
            ...
            <div className="mobile-nav-links">
              ...
              <Link
                to="/training"
                className={`mobile-nav-link ${location.pathname === "/training" ? "active" : ""}`}
                onClick={closeMobileMenu}
              >
                Training
              </Link>
              <Link
                to="/registration"
                className={`mobile-nav-link ${location.pathname === "/registration" ? "active" : ""}`}
                onClick={closeMobileMenu}
              >
                Registration
              </Link>
              ...
              <Link
                to="/upcoming"
                className={`mobile-nav-link ${location.pathname === "/upcoming" ? "active" : ""}`}
                onClick={closeMobileMenu}
              >
                Upcoming-Event
              </Link>
              ...
              <Link
                to="/donation"
                className={`mobile-nav-link ${location.pathname === "/donation" ? "active" : ""}`}
                onClick={closeMobileMenu}
              >
                Donate
              </Link>
